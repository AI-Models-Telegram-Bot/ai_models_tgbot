...
const MODEL_DEFAULTS: Record<string, VideoModelSettings> = {
  ...
  'seedance-2': { aspectRatio: '16:9', duration: 5, resolution: '720p', generateAudio: true, webSearch: false, nsfwChecker: false, mode: 'text' },
  'seedance-2-fast': { aspectRatio: '16:9', duration: 5, resolution: '720p', generateAudio: true, webSearch: false, nsfwChecker: false, mode: 'text' },
  'topaz': { upscale: '2x' },
