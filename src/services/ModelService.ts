...
const SLUG_TO_PRICE: Record<string, string> = {
  ...
  'seedance-2': 'VIDEO_SEEDANCE_2',
  'seedance-2-fast': 'VIDEO_SEEDANCE_2_FAST',
  'topaz': 'VIDEO_TOPAZ',
...
export class ModelService {
  ...
  async seedDefaultModels(): Promise<void> {
    const models: {
      ...
      { name: 'Veo Fast', slug: 'veo-fast', provider: 'kieai', category: 'VIDEO', tokenCost: 30, priceItemCode: 'VIDEO_VEO_FAST', description: 'Google Veo 3.1 Fast' },
      ...
      { name: 'Seedance 2 Fast', slug: 'seedance-2-fast', provider: 'kieai', category: 'VIDEO', tokenCost: 55, priceItemCode: 'VIDEO_SEEDANCE_2_FAST', description: 'ByteDance Seedance 2 Fast — newest gen, fast 480p/720p (⚡12–165)' },
      { name: 'Seedance 2', slug: 'seedance-2', provider: 'kieai', category: 'VIDEO', tokenCost: 65, priceItemCode: 'VIDEO_SEEDANCE_2', description: 'ByteDance Seedance 2 — newest gen, premium 480p/720p/1080p (⚡16–480)' },
      ...
      { name: 'Veo Quality', slug: 'veo', provider: 'kieai', category: 'VIDEO', tokenCost: 140, priceItemCode: 'VIDEO_VEO', description: 'Google Veo 3.1 Quality — best video quality' },
