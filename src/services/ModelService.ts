...
export class ModelService {
  ...
  async seedDefaultModels(): Promise<void> {
    const models: {
      ...
      { name: 'Fast Text', slug: 'fast-text', provider: 'groq', category: 'TEXT', tokenCost: 1, priceItemCode: 'TEXT_FAST', description: 'Llama 3.3 70B — fast & free via Groq' },
      { name: 'Grok', slug: 'grok', provider: 'xai', category: 'TEXT', tokenCost: 5, priceItemCode: 'TEXT_GROK', description: 'xAI Grok model' },
      { name: 'Gemini Flash', slug: 'gemini-flash', provider: 'google', category: 'TEXT', tokenCost: 1, priceItemCode: 'TEXT_GEMINI_FLASH', description: 'Google Gemini 2.5 Flash — fast & cheap' },
      { name: 'Gemini Pro', slug: 'gemini-pro', provider: 'google', category: 'TEXT', tokenCost: 5, priceItemCode: 'TEXT_GEMINI_PRO', description: 'Google Gemini 2.5 Pro — premium reasoning' },
      { name: 'DeepSeek R1', slug: 'deepseek-r1', provider: 'together', category: 'TEXT', tokenCost: 5, priceItemCode: 'TEXT_DEEPSEEK_R1', description: 'DeepSeek R1 — open-source reasoning model' },
      { name: 'Llama 4 Maverick', slug: 'llama-4-maverick', provider: 'together', category: 'TEXT', tokenCost: 3, priceItemCode: 'TEXT_LLAMA4_MAVERICK', description: 'Meta Llama 4 Maverick — latest open-source' },
      ...
      { name: 'Seedream 4.5 Beta', slug: 'seedream-4.5', provider: 'kieai', category: 'IMAGE', tokenCost: 8, priceItemCode: 'IMAGE_SEEDREAM_45', description: 'ByteDance Seedream 4.5 Beta — latest model with 1K/2K/4K quality (⚡8-15)' },
      ...
      { name: 'Kling Pro', slug: 'kling-pro', provider: 'piapi', category: 'VIDEO', tokenCost: 20, priceItemCode: 'VIDEO_KLING_PRO', description: 'Kling Pro — premium quality with all versions (20–116 credits)' },
      ...
      { name: 'Sora 2', slug: 'sora', provider: 'kieai', category: 'VIDEO', tokenCost: 25, priceItemCode: 'VIDEO_SORA', description: 'OpenAI Sora 2 text-to-video (~$0.50)' },
      { name: 'Sora 2 Pro', slug: 'sora-pro', provider: 'kieai', category: 'VIDEO', tokenCost: 40, priceItemCode: 'VIDEO_SORA_PRO', description: 'OpenAI Sora 2 Pro — premium quality video (~$0.80)' },
