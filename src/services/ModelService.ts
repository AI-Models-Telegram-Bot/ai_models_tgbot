...
const SLUG_TO_PRICE: Record<string, string> = {
  ...
  'kling-master': 'VIDEO_KLING_MASTER',
  'luma': 'VIDEO_LUMA',
  'wan': 'VIDEO_WAN',
...
export class ModelService {
  ...
  async seedDefaultModels(): Promise<void> {
    const models: {
      ...
      { name: 'Kling Master', slug: 'kling-master', provider: 'piapi', category: 'VIDEO', tokenCost: 40, priceItemCode: 'VIDEO_KLING_MASTER', description: 'Kling Master — highest quality cinematic video (~$1.00)' },
