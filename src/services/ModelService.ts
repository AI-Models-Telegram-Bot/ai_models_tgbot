...
export class ModelService {
  ...
  async seedDefaultModels(): Promise<void> {
    const models: {
      ...
      { name: 'Seedance 2 Fast', slug: 'seedance-2-fast', provider: 'kieai', category: 'VIDEO', tokenCost: 70, priceItemCode: 'VIDEO_SEEDANCE_2_FAST', description: 'ByteDance Seedance 2 Fast — newest gen, fast 480p/720p (⚡16–140)' },
      { name: 'Seedance 2', slug: 'seedance-2', provider: 'kieai', category: 'VIDEO', tokenCost: 70, priceItemCode: 'VIDEO_SEEDANCE_2', description: 'ByteDance Seedance 2 — newest gen, premium 480p/720p (⚡16–140)' },
