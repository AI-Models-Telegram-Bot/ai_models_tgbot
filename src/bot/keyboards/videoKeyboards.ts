...
export function getVideoFamiliesKeyboard(lang: Language) {
  ...
  return Markup.keyboard([
    ...
    [l.buttons.videoSeedanceFamily, l.buttons.videoEnhancementFamily],
    [l.buttons.mainMenu],
  ]).resize();
}
...
export function getKlingModelsKeyboard(lang: Language) {
  ...
  return Markup.keyboard([
    ...
    [l.buttons.videoKling30, l.buttons.videoKlingMotion],
    [l.buttons.videoKlingAvatarPro, l.buttons.videoKlingAvatar],
