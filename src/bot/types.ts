...
export interface BotContext extends Context {
  ...
  session?: {
    ...
    uploadedVideoUrl?: string; // Video URL for Kling Motion Control / Enhancement
    uploadedAudioUrl?: string; // Audio URL for Kling AI Avatar
    videoMeta?: { width?: number; height?: number; duration?: number; fileSize?: number; mimeType?: string };
