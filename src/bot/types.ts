...
export type VideoFunction = 'kling' | 'kling-pro' | 'kling-3.0' | 'kling-motion' | 'kling-avatar-pro' | 'kling-avatar' | 'veo-fast' | 'veo' | 'sora' | 'sora-pro' | 'runway' | 'runway-gen4' | 'luma' | 'wan' | 'seedance' | 'seedance-lite' | 'seedance-1-pro' | 'seedance-fast';
